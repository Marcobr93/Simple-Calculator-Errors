...
public class CalcActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void makeOperation() {
        double total = 0;
        /**
         * Si no controlamos que el número sea igual al anterior, povocamos al pulsar el botón " = ",
         * en vez de realizar la misma operación con el último número introducido, se realizaría con
         * el total, es decir --> 55 + 5 = 60, al pulsar " = " daría 120 en vez de 65.
         */
        if (!igualAnterior){
        ...
        /**
         * Ponemos igualAnterior a true para que no realice la operación sobre el total y si sobre
         * el último número.
         */
        igualAnterior = true;

        /**
         * Si hacemos que mAccumulator sea igual al total, conseguimos que al pulsar el botón " = ",
         * podamos realizar la misma operación con el último número introducido.
         */
        mAccumulator = total;
    ...
    private void addPoint() {
        if (resultTextView.getText().toString().indexOf('.') == -1) {
            ...
            /**
             * Si resultTexView no contiene un "." , podemos añadirlo.
             */
